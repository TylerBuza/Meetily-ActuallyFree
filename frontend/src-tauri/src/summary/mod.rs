...
pub use template_commands::{
    ...
    __cmd__api_is_custom_template, __cmd__api_list_templates, __cmd__api_save_custom_template,
    __cmd__api_validate_template, __tauri_command_name_api_delete_custom_template,
    __tauri_command_name_api_get_template_details, __tauri_command_name_api_is_custom_template,
    __tauri_command_name_api_list_templates, __tauri_command_name_api_save_custom_template,
    __tauri_command_name_api_validate_template, api_delete_custom_template,
    api_get_template_details, api_is_custom_template, api_list_templates, api_save_custom_template,
